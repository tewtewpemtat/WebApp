...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2022 at 07:40 AM
...
--
-- Table structure for table `conmment`
--
...
--
-- Indexes for table `conmment`
--
ALTER TABLE `conmment`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `conmment`
--
ALTER TABLE `conmment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
