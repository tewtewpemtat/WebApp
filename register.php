...
<body>
    ...
    <table style="border: 2px solid black ; width: 40% " align="center">
        ...
        <tr><td>รหัสผ่าน :</td><td><input type="text" name="รหัสผ่าน" size="50" ></td></tr>
        ...
        <tr><td>เพศ :</td><td> 
            ...
            <input type="radio" name="gender" value="m"> อื่นๆ<br>
        </td>  
    ...
    <div align="center"><a href="index2.php">กลับหน้าหลัก</a></div>
