...
<nav class="navbar navbar-expand-ig navbar-light" style="background-color: #D3D3D3;">
            <div class="container">
            <a href="index2.php" class="navbar-brand"><i class ="bi bi-house-door-fill"></i> Home</a>
            <ul class="navbar-nav">
                <li class="nav-item">
